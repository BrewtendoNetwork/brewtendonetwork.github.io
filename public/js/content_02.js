			...
			<h1 id="header-guide-orange">Brewtendo installation guide:</h1>
		            <div class="style-center-container" class="guide-txt">
                        ...
                        <div class="style-center-div-nocolor" id="float">
							...
							<hr style="width:90%;" />
							<div class="pill-button" style="margin-bottom:15px;margin-top:15px;" onclick="changeContent('guide_1'); swapStyleSheet('public/css/guide.css'); playAudio('decide');">
			...
			<h1 id="header-guide-orange">Brewtendo installation guide:</h1>
		        <div class="style-center-container" class="guide-txt">
                    ...
                    <div class="style-center-div-nocolor" id="float">
						...
						<hr style="width:90%;" />
						<div class="pill-button" style="margin-bottom:15px;margin-top:15px;" onclick="changeContent('guide_2'); swapStyleSheet('public/css/guide.css'); playAudio('decide');">
			...
			<h1 id="header-guide-orange">Brewtendo installation guide:</h1>
		        <div class="style-center-container" class="guide-txt">
                    ...
                    <div class="style-center-div-nocolor" id="float">
						...
						<hr style="width:90%;" />
						<div class="pill-button" style="margin-bottom:15px;margin-top:15px;" onclick="changeContent('badgearcade'); swapStyleSheet('public/css/guide.css'); playAudio('decide');">
